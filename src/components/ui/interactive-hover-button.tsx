...
>(({ text = "Button", className, ...props }, ref) => {
  return (
    ...
    >
      ...
      <div className="absolute left-[20%] top-[40%] h-2 w-2 scale-[1] rounded-full bg-zinc-900 transition-all duration-300 group-hover:left-[0%] group-hover:top-[0%] group-hover:h-full group-hover:w-full group-hover:scale-[1.8] group-hover:bg-zinc-900 dark:bg-zinc-50 dark:group-hover:bg-zinc-50"></div>
    </button>
  );
});
